...
public class SignUpActivity extends AppCompatActivity implements SignUpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                user = edEmail.getText().toString().trim();
    ...
    public void Signup(){
        ...
        if (!user.matches(emailPattern) || user.length()<=5 ){
            Toast.makeText(this, "Mời bạn nhập đúng định dạng email!", Toast.LENGTH_SHORT).show();
        }
        else if ( pass.length() <= 5 ){
            Toast.makeText(this, "Mật khẩu phải hơn 5 kí tự !", Toast.LENGTH_SHORT).show();
        }
        else if (!confirmpass.equals(pass)){
            Toast.makeText(this, "Mật khẩu phải phải khớp nhau!", Toast.LENGTH_SHORT).show();
        }
